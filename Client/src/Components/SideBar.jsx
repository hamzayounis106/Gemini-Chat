...
function SideBar() {
  return (
    <>
      <div className="max-w-[20%] w-full max-h-full bg-zinc-900 border-r-2 border-[#94a3b833] flex justify-between items-center pt-2 flex-col">
        <div className="flex items-center justify-center w-full ">
          <div className="flex items-center overflow-y-clip overflow-x-hidden justify-between p-2 pl-3  mt-2 w-[90%] bg-zinc-700 cursor-pointer rounded-md">
